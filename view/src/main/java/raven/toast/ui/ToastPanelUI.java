...
import static raven.toast.ToastClientProperties.TOAST_CLOSE_CALLBACK;
import static raven.toast.ToastClientProperties.TOAST_COMPONENT;
import static raven.toast.ToastClientProperties.TOAST_ICON;
import static raven.toast.ToastClientProperties.TOAST_SHOW_CLOSE_BUTTON;
...
public class ToastPanelUI extends BasicPanelUI implements StyleableUI, PropertyChangeListener {
    ...
    protected void installDefaults(JPanel p) {
        ...
        closeButtonIcon = UIUtils.getIcon(prefix + ".closeIcon", FontIcon.of(Codicons.CLOSE, 24, closeIconColor));
