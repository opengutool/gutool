...
public class FindReplaceBar {
    ...
    public FindReplaceBar(RSyntaxTextArea textArea) {
        ...
        findPreviousButton.setIcon(FontIcon.of(Codicons.ARROW_SMALL_UP, 18));
        findNextButton.setIcon(FontIcon.of(Codicons.ARROW_SMALL_DOWN, 18));
        closeButton.setIcon(FontIcon.of(Codicons.REMOVE, 18));
