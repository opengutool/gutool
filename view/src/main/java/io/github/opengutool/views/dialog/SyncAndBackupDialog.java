...
public class SyncAndBackupDialog extends JDialog {
    ...
    public SyncAndBackupDialog() {
        super(GutoolApp.mainFrame, "同步和备份");
        ...
        String localDataPath = SystemUtil.CONFIG_HOME + File.separator + "gutool.db";
        ...
        exportDataButton.addActionListener(e -> {
            JFileChooser fileChooser = new JFileChooser(GutoolApp.config.getQuickNoteExportPath());
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("用于同步Gutool数据的Git仓库地址：");
